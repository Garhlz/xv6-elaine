...
#define E1000_IMS_RXDMT0 (1 << 4) // Rx Descriptor Minimum Threshold
#define E1000_IMS_RXO (1 << 6)    // Rx Overflow
#define E1000_IMS_RXT0 (1 << 7)   // Rx Timer Interrupt

/* Interrupt Cause Read */
// The layout is the same as IMS
